...
var Grid = (function() {
	...
	function initItemsEvents( $items ) {
		...
		$('#gallery-grid li').children( 'a' ).on( 'click', function(e) {
			$('#gallery-grid li').removeClass('gallery-expanded');
		...
		$('#gallery-grid li').on( 'click', 'span.gallery-close', function() {
			hidePreview();
			$('#gallery-grid li').removeClass('gallery-expanded');
			return false;
		} );
	...
	Preview.prototype = {
		...
		close : function() {
			...
			$('#gallery-grid li').css( { 'transition': 'height 350ms ease', 'height': 335 } );
			return false;
		...
		setHeights : function() {
			...
			this.$item.css( 'height', 835 ).on( transEndEventName, onEndFn );
		...
		setTransition  : function() {
			this.$previewEl.css( { 'transition': 'height ' + settings.speed + 'ms ' + settings.easing, 'height': 500 });
			this.$item.css( { 'transition': 'height ' + settings.speed + 'ms ' + settings.easing, 'height': 500 });
		},
		getEl : function() {
